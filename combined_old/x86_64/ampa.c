	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 AMPA /Users/jiemei/Desktop/combined_v2/trial/combined_old/x86_64/ampa.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("AMPA", "cannot be used with CVODE");}
