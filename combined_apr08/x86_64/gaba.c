...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 GABAa /Users/jiemei/Desktop/combined_v2/trial_updated/combined_apr08/x86_64/gaba.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("GABAa", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 122 in file gaba.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
