...
#define _tqitem &(_ppvar[2]._pvoid)
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 AMPA /Users/jiemei/Desktop/combined_v2/trial/combined/x86_64/ampa.mod\n");
...
static double _hoc_Exp1(_vptr) void* _vptr; {
 double _r;
    _hoc_setdata(_vptr);
 _r =  Exp1 (  *getarg(1) ) ;
 return(_r);
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 46 in file ampa.mod:\n  SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
