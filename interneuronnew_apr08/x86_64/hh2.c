...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 6);
 	...
 	ivoc_help("help ?1 hh2 /Users/jiemei/Desktop/combined_v2/trial/interneuronnew/x86_64/hh2.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("hh2", "cannot be used with CVODE");}
