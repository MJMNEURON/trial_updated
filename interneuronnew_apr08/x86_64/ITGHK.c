...
#define nongat nongat_itGHK
 ...
 extern double nongat( double , double , double );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 itGHK /Users/jiemei/Desktop/combined_v2/trial/interneuronnew/x86_64/ITGHK.mod\n");
...
double nongat (  double _lv , double _lcai , double _lcao ) {
   double _lnongat;
...
static int _hoc_nongat() {
  double _r;
   _r =  nongat (  *getarg(1) , *getarg(2) , *getarg(3) );
 ret(_r);
}
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 73 in file ITGHK.mod:\n	SOLVE castate METHOD euler\n"); nrn_complain(_p); abort_run(error);}
